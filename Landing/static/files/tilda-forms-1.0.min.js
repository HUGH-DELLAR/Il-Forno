  ...
  (function ($) {
    (window.scriptSysPayment = {}),
      ...
      $(document).ready(function () {
          ...
          (window.tildaForm.send = function (
            ...
            if (2 == formtype || (!formtype && "" < formskey)) {
              ...
              ($inputElem && 0 != $inputElem.length) ||
                ...
                ($inputElem && 0 != $inputElem.length) ||
                  ($jform.append(
                    '<input type="hidden" name="tildaspec-referer" value="http://il-forno.tilda.ws/quattro_formaggi">'
                  ),
                  ($inputElem = $jform.find("input[name=tildaspec-referer]"))),
                0 < $inputElem.length && $inputElem.val('http://il-forno.tilda.ws/quattro_formaggi'),
              ...
              $jform.find(".js-form-spec-comments").val(""),
                ($formurl =
                  "https://" + 'il-forno.tilda.ws/quattro_formaggi' + "/procces/");
              var d = {};
              if (
                          ...
                          "undefined" != typeof ga &&
                            ...
                            "" < window.mainMetrika &&
                              ...
                              window[window.mainMetrika].hit(virtPage, {
                                title: virtTitle,
                                referer: "http://il-forno.tilda.ws/quattro_formaggi",
                              });
                        } catch (e) {
                          console.log(e);
                        }
        ...
        try {
          var TILDAPAGE_URL = 'http://il-forno.tilda.ws/quattro_formaggi',
            TILDAPAGE_QUERY = "",
            TILDAPAGE_UTM = "";
          if (
